...
<head>
    ...
    <link href="//<?php echo $data->server_name; ?>/assets/5.6.14.1/account.css" rel="stylesheet"/>
    <script src="//<?php echo $data->server_name; ?>/assets/5.6.14.1/account.js" type="text/javascript"></script>
...
<div class="milestone-wrapper wrapper" id="wrapper">
    ...
    <img src="//<?php echo $data->server_name; ?>/assets/omerta/main/account/assets/img/create-the-next-don.png" class="milestone-wrapper-title-slogan" alt="">
    ...
    <div class="right-col character-col">
        <div class="ribbon"><img src="//<?php echo $data->server_name; ?>/assets/omerta/main/account/assets/img/corner-ribbon.png"/></div>
...
<div id="footer-container" class="footer"
    ...
    <div class="test" style="margin-top: -70px">
        ...
        <ul class="top-tabs">
            <li><a href="javascript:void(0)" data-bind="click: setTabSettings">My Settings</a></li>
            <li><a href="javascript:void(0)" data-bind="click: setTabDead">Dead Accounts</a></li>
            <li><a href="/logout.php">Log Out from Omerta</a></li>
        </ul>
    </div>
                ...
                <ul class="bottom-tabs">
                    <li>
                        <a href="javascript:void(0)"
                           data-bind="click: setTabSettings, css: {active: isEnabledTabSetting()}">My Settings</a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"
                ...
                <script type="text/html" id="fieldset-template">
                    <fieldset class="fieldset">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="javascript:void(0)" data-bind="click: toggleForm, text: showValue() ? editable ? 'Set' : 'Close' : 'Change'" class="btn btn-small btn-blue">Change</a>
                        </div>
                    </fieldset>
                </script>
