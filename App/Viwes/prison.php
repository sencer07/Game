    ...
    <tr>
        <td align="center"><img src=/static/images/game/generic/criminal.jpg width=144 height=172 border=1><br>You are
            in jail for the next<img rel="tooltip" src="/static/images/game/generic/tooltip.png"
                    ...
                    data-time-end='1591804486'>42 seconds</span><br><br>
            <form method="post" action="/iminjail.php"><input type="submit" name="buymeout"
                                                              value="Buy yourself out for $ 650"><img rel="tooltip"
                                                                                                      src="/static/images/game/generic/tooltip.png"
                                                                                                      title="You can buy yourself out of jail, but it will cost you money."><br><br>
            </form>
        </td>
