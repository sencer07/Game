...
<head>
    ...
    <title id="pageTitle">Omerta (COM)</title>
...
<div id="splash_loading"
     style="display: block; position: fixed; top: 0; left: 0; bottom: 0; width: 100%; height: 100%; overflow: hidden; background: #000000 url('//<?php echo $data->server_name; ?>/assets/omerta/main/layout/assets/img/splash/loading/com-background.jpg') no-repeat center center; background-size: cover; z-index: 99999;">
    <div>
        ...
        <div style="text-shadow: 0 1px 1px rgba(0,0,1,.3); position: absolute; top: 65%; left: 50%; width: 300px; margin-left: -120px; text-align: left;">
            ...
            <div style="float: left; color: white;">
                ...
                <span style="font-size: 10px;">COM - Round #23
                    <br></span>
            </div>
        </div>
    ...
    <header>
        ...
        <div id="omerta_bar">
            ...
            <ul class="mobile-top-nav nav-right">
                ...
                <li id="mobile-top-item-donate" class="pull-right"><a class="link-button" href="/?module=Donate.Methods">Donate</a></li>
                ...
                <li id="mobile-top-item-mail-alert" class="top-item pull-right"><a class="top-button messages" href="/?module=Mail" data-wtype="inbox-alert" data-counts="0">
                        <span class="sidebar-bubble-number hidden">0</span></a></li>
                <li class="top-item pull-right boost-item">
            ...
            <ul class="top-nav" data-viewport="desktop">
                ...
                <li class="pull-right icon">
                    <a data-wtype="tickets" href="/tickets" target="_blank" id="bubble-tickets">
                ...
                <li class="pull-right bar bar-support"><a
                        href="/?module=Donate.Methods">Support Omerta</a></li>
            </ul>
        </div>
        ...
        <div data-viewport="desktop" id="countdown" data-bind="visible: showWidget(), css: {'counting-down': !showWinner(), 'show-winner': showWinner(), 'show-loader': showLoader()},event: { mouseover: enableDetails, mouseout: disableDetails } ">
			...
			<span class="button red" data-bind="click: redirectToMap">City Map</span>
		</span>
            ...
            <div class="family" data-bind="click: redirectToFamily">
                ...
                <span class="winner" data-bind="text: data().familyname">Family</span>
        ...
        <div class="Milestones_popup" data-bind="visible: omerta.services.account.isMilestoneWaiting() && omerta.GUI.container.currentModule() != 'Milestone'">
            ...
            <img class="Milestones_popup_icon"src="//<?php echo $data->server_name; ?>/assets/omerta/main/account/assets/img/milestone_popup_icon.png" alt="Collect this milestone!">
            <p>
        ...
        <div id="game_bar">
            ...
            <div class="cooldowns-knob pull-left">
                <div data-cooldown="crime">
                    <input data-knob-timeend="1590792689"
                ...
                <div data-cooldown="car">
                    <input data-knob-timeend="1590810175"
                ...
                <div data-cooldown="travel">
                    <input data-knob-timeend="0"
                           data-knob-timetotal="4500"
                           value="0"
                           data-width="46"
                           autocomplete="off"
                           data-skin="tron"
            ...
            <div class="bars-container">
                ...
                <div class="top-city-tab pull-left">
                    <div class="top-city-text"><a href="/?module=City"
                                                  data-bind="text: character.city()">New York</a></div>
                </div>

                <!-- Health -->
                <div class="bar-info bar-info-health pull-right" data-bind="click: omerta.GUI.menu.loadMenuItem.bind($data, 'city-hospital', false)">
                    <div class="icon"><img
                            src="//<?php echo $data->server_name; ?>/assets/omerta/main/layout/assets/img/barinfo/icon-health.png">
                    </div>
                    ...
                    <div class="progressbar-label-wrapper">
                        <div class="progressbar-label-container">
                            Health: <span class="green"><span data-bind="text: omerta.character.progress.health"></span>%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bar-info bar-info-rank pull-right" data-bind="click: omerta.GUI.menu.loadMenuItem.bind($data, 'account-launchpad', {oTab: 'actions'})">
                    ...
                    <img class="seperator" src="//<?php echo $data->server_name; ?>/assets/omerta/main/layout/assets/img/barinfo/seperator.png"
                         align="absmiddle"/>
                    ...
                    <div class="progressbar-label-wrapper">
                        <div class="progressbar-label-container">
                            Rank progress: <span class="yellow"><span data-bind="text: omerta.character.progress.rank_progress"></span>%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bar-info bar-info-rank pull-right popup-info" data-title="Account Plating" data-url="/?module=Services.AccountPlating&action=getCooldownInfo">
                    ...
                    <img class="seperator" src="//<?php echo $data->server_name; ?>/assets/omerta/main/layout/assets/img/barinfo/seperator.png"  align="absmiddle"/>

                    <div class="progressbar-container">
                        <div style="margin-top: -10px; color: #afafa5; text-align: center;">
                            <i class="fa fa-check"></i> PROTECTED
                        </div>
                    </div>
                    <div class="progressbar-label-wrapper">
                        <div class="progressbar-label-container">
                    ...
                    <div class="profile-image-wrapper">
                        <div class="profile-image-container">
                            ...
                            <div class="info-points">
                                <span>Position:</span> <strong data-bind="text: progress.position"></strong><br/>
                                <span>Points:</span> <strong data-bind="text: progress.leader_points"></strong>
                            </div>
                        </div>
                    </div>
            ...
            <div class="actions">
                <div class="city">
                    <a href="/?module=City" data-page-title="City">
                        ...
                        <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/map.png"/>
                        <img class="hover" src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/map-hover.png"/>
                ...
                <div class="mail" data-wtype="inbox">
                    <a href="/?module=Mail" data-page-title="Mail">
                        <span class="sidebar-bubble-number hidden">0</span>
                        <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/mail.png"/>
                        <img class="hover" src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/mail-hover.png"/>
                ...
                <div class="alerts" data-wtype="alert">
                    <a href="/?module=Mail" data-page-title="Mail">
                        <span class="sidebar-bubble-number hidden">0</span>
                        <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/alert.png"/>
                        <img class="hover" src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/alert-hover.png"/>
                ...
                <div class="chat" data-wtype="chat" data-bind="with: omerta.widgets.Sidepanel">
                    <a href="javascript:void(0)" data-bind="click: UI.events.toggle">
                        <span class="sidebar-bubble-number hidden">0</span>
                        <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/chat.png"/>
                        <img class="hover" src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/Sidebar/assets/img/icons/chat-hover.png"/>
            ...
            <div id="game_wrapper_container">
                <div class="title">
                    ...
                    <ul class="account-settings">
                        <li><a href="/user.php" class="fa fa-user" title="My Profile"></a></li>
                        ...
                        <ul class="list-inline character-stats-wrapper bottom-info-money">
                            <li>
                                <a href="/bank.php" title="Pocket money">
                                    <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/CharacterStats/assets/img/money-bag.png" alt="money-bag">
                            ...
                            <li>
                                <a href="/bank.php" title="Bank money">
                                    <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/CharacterStats/assets/img/money-safe.png"
                                         alt="money-safe">
                        ...
                        <ul class="list-inline character-stats-wrapper bottom-info-bullets">
                            <li>
                                <a href="/bullets2.php" title="Bullets">
                                    <img src="//<?php echo $data->server_name; ?>/assets/omerta/widgets/CharacterStats/assets/img/bullets.png" alt="bullet-img">
...
<script type="text/html" id="tpl_chat_message" xmlns="http://www.w3.org/1999/html">
    <div class="user-message-text" data-bind="visible: omerta.chat.blacklist.indexOf($data.getFrom()) === -1, css: { 'msg-hilight': $data.isHilight(), 'msg-removed': $data.removed() }">
        ...
        <span class="msg-content chat-sender-system" data-bind="visible: $data.isSystem()" style="padding-left: 5px;">
...
<div id="omerta_sidepanel" data-bind="with: widgets.Sidepanel">
    ...
    <div id="omerta_sidepanel_chat" data-bind="with: omerta.chat">
        ...
        <div class="loading" data-bind="visible: loading() && show()">
            <div>
                <i style="color:white;" class="icon-spinner icon-spin icon-large">&nbsp;</i> Loading Chat ...
            </div>
        </div>
            ...
            <div class="omerta_chat_widget">
                ...
                <div class="omerta_chat_input">
                    <form action="#" method="POST" data-bind="submit: data.sendGeneral, visible: !($data.banned())">
                        <textarea maxlength="254" id="omerta_chat_input_g" class="omerta_chat_input_text" data-lpignore="true" autocomplete="off" placeholder="Write a new message..."/></textarea>
                    </form>
            ...
            <div class="omerta_chat_widget">
                ...
                <div class="omerta_chat_input">
                    <form action="#" method="POST" data-bind="submit: data.send, visible: !($data.banned())">
                        <textarea type="text" maxlength="254" id="omerta_chat_input" class="omerta_chat_input_text" data-lpignore="true" autocomplete="off" placeholder="Write a new message..."/></textarea>
                        <a data-bind="click: utils.scrollChat, visible: UI.newMessage" href="javascript: void(0)" data-wtip="New message received, click here to scroll" style="position:absolute; right: 3px; bottom: 7px; font-size: 17px; text-decoration: none;"><i class="ci icon-exclamation-sign"></i></a>
                    </form>
                    <p data-bind="visible: $data.banned()" style="color: #f06464; font-weight: bold;padding-left: 5px;">
                        <i class="fa fa-ban"></i> You are banned from chat.</p>
                </div>
...
<div id="dead-container" class="deadContainerWrapper">
    <div class="dead-body">
        ...
        <div class="dead-skull">
            <img src="//<?php echo $data->server_name; ?>/assets/omerta/main/layout/assets/img/skull/skull-big-2.png?r=1" alt="dead skull"/>
        </div>
        <div class="dead-foot">
